  ...
  const [tickets, setTickets] = useState<KitchenTicket[]>([
    {
      ...
      table: 'Bàn A1-01',
      items: [
        { name: 'Cơm Gà Xối Mỡ Giòn Da', qty: 2, note: 'Nhiều cơm, ít mỡ hành' },
        { name: 'Trà Đào Cam Sả', qty: 1, note: 'Ít đá' },
      ],
      status: 'PREPARING',
      orderTime: '12:45',
      elapsedMinutes: 8,
    },
    {
      ...
      table: 'Bàn A1-02',
      items: [
        { name: 'Cơm Sườn Nướng Mật Ong', qty: 1 },
      ],
      status: 'WAITING',
      orderTime: '12:48',
      elapsedMinutes: 5,
    },
    {
      ...
      table: 'Mang Về',
      items: [
        { name: 'Phở Bò Tái Hà Nội', qty: 1, note: 'Bánh phở mềm, không hành' },
      ],
      status: 'WAITING',
      orderTime: '12:50',
      elapsedMinutes: 3,
    },
    {
      ...
      table: 'Bàn A1-04',
      items: [
        { name: 'Bún Bò Huế Đặc Biệt', qty: 1 },
      ],
      status: 'READY',
      orderTime: '12:35',
      elapsedMinutes: 18,
